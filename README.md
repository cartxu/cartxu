...
* **Gifs App**: *web app created with react and giphy. You can add gif categories to the main page to bring related gifs, delete them or copy the gif url to your clipboard by clicking on the gif.* [Live](https://gifs-e5erhj6lm-cartxu.vercel.app/) | [Code](https://github.com/cartxu/search-gifs)
